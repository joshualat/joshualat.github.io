...
jlslides.directive("slidenav", function () {
  return {
    ...
    template: '<div class="slide-nav"><a href="http://joshualat.com"><img id="jllogo" src="../shared/images/JL.png" width="40px" height="40px"/></a><slidetitle></slidetitle><slideforward></slideforward><slidenumber></slidenumber><slideback></slideback><div class="clear"></div></div>',
